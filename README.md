...
Full documentation (installation, configuration, data formats, pipeline internals, SHACL constraints, running on your own graph, troubleshooting) is in [docs/](docs/README.md).
